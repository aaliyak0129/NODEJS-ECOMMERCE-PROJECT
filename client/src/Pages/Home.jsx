...
const Home = () => {
  return (
    ...
    <div>
           <Carousel>
      <Carousel.Item>
<img src={img1} className="slide" alt="" />        <Carousel.Caption>
          <h3>First slide label</h3>
          <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
<img src={img2} className="slide" alt="" />         <Carousel.Caption>
          <h3>Second slide label</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
<img src={img3} className="slide" alt="" />         <Carousel.Caption>
...
Black Friday Offer       ✿    The Iconic Collection    ✿    Elegant and Everlasting     ✿    Color In Your Looks    ✿    Black Friday Offer       ✿    The Iconic Collection    ✿    Elegant and Everlasting     ✿    Color In Your Looks Black Friday Offer    ✿ The Iconic Collection ✿ Elegant and Everlasting  ✿ Color In Your Looks ✿ Black Friday Offer    ✿ The Iconic Collection ✿ Elegant and Everlasting  ✿ Color In Your Looks
...
Black Friday Offer       ✿    The Iconic Collection    ✿    Elegant and Everlasting     ✿    Color In Your Looks    ✿    Black Friday Offer       ✿    The Iconic Collection    ✿    Elegant and Everlasting     ✿    Color In Your Looks Black Friday Offer    ✿ The Iconic Collection ✿ Elegant and Everlasting  ✿ Color In Your Looks ✿ Black Friday Offer    ✿ The Iconic Collection ✿ Elegant and Everlasting  ✿ Color In Your Looks
    ...
    <h2 style={{textAlign:"center",fontSize:"15px"}}>Our jewelry is made by the finest artists and carefully selected to reflect your style and personality</h2>
    ...
    <h1 style={{textAlign:"center",marginTop:"20px"}}>Most Purchased Product</h1>
        <div className="card-container">
      <div className="product-card">
  ...
  <div className="gallery-grid">
      <div className="gallery-card">
        <img src={img11} alt="1" />
        <div className="gallery-title">Image Title 1</div>
        <div className="gallery-hover-text">This is hover text for Image 1.</div>
      </div>

      <div className="gallery-card">
        <img src={img12} alt="2" />
        <div className="gallery-title">Image Title 2</div>
        <div className="gallery-hover-text">This is hover text for Image 2.</div>
      </div>

      <div className="gallery-card">
        <img src={img13} alt="3" />
        <div className="gallery-title">Image Title 3</div>
        <div className="gallery-hover-text">This is hover text for Image 3.</div>
      </div>

      <div className="gallery-card">
        <img src={img14} alt="4" />
        <div className="gallery-title">Image Title 4</div>
        <div className="gallery-hover-text">This is hover text for Image 4.</div>
      </div>
    </div>
 ...
 <div className="side-container">
      ...
      <div className="testimonials-grid">
        <div className="testimonial-card">
          <p className="testimonial-text">"Absolutely stunning! The necklace I bought was even more beautiful in person. Will definitely order again."</p>
        ...
        <div className="testimonial-card">
          <p className="testimonial-text">"Great quality and fast delivery. Their customer service was very helpful too."</p>
        ...
        <div className="testimonial-card">
          <p className="testimonial-text">"Bought a bridal set — it made my day so special. Got so many compliments!"</p>
        ...
        <div className="testimonial-card">
          <p className="testimonial-text">"Beautiful craftsmanship and elegant designs. I’m obsessed!"</p>
